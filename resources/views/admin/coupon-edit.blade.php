                ...
                <form class="form-new-product form-style-1" method="POST" action="{{ route('admin.coupon.update') }}">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('code') is-invalid @enderror" type="text"
                            placeholder="Coupon Code" name="code" value="{{ $coupon->code }}" tabindex="0"
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('value') is-invalid @enderror" type="text"
                            placeholder="Coupon Value" name="value" value="{{ $coupon->value }}" tabindex="0"
                            value="" aria-required="true">
                    </fieldset>
                    @error('value')
                        <span class="invalid-feedback" style="font-size: 1.2rem" role="alert">
                    ...
                    <fieldset class="name">
                        ...
                        <input class="flex-grow @error('cart_value') is-invalid @enderror" type="text"
                            placeholder="Cart Value" name="cart_value" value="{{ $coupon->cart_value }}" tabindex="0"
                            value="" aria-required="true">
                    </fieldset>
                    @error('cart_value')
                        <span class="invalid-feedback" style="font-size: 1.2rem" role="alert">
                    ...
                    <fieldset class="name">
                        ...
                        <input id="expiry_date" class="flex-grow @error('expiry_date') is-invalid @enderror" type="date"
                            placeholder="Expiry Date" name="expiry_date" value="{{ $coupon->expiry_date }}" tabindex="0"
                            value="" aria-required="true">
                    </fieldset>
                    @error('expiry_date')
                        <span class="invalid-feedback" style="font-size: 1.2rem" role="alert">
