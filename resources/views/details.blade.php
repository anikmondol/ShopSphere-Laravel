            ...
            <div class="row">
                            ...
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gImage)
                                        <div class="swiper-slide product-single__image-item">
                                            <img loading="lazy" class="h-auto"
                                                src="{{ asset('uploads/products') }}/{{ $gImage }}" width="674"
                                                height="674" alt="" />
                                            <a data-fancybox="gallery"
                                                href="{{ asset('uploads/products') }}/{{ $gImage }}"
                                                data-bs-toggle="tooltip" data-bs-placement="left" title="Zoom">
                                                <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                                                    xmlns="http://www.w3.org/2000/svg">
                                                    <use href="#icon_zoom" />
                                ...
                                <div class="swiper-wrapper">
                                    ...
                                    @foreach (explode(',', $product->images) as $gImage)
                                        <div class="swiper-slide product-single__image-item"><img loading="lazy"
                                                class="h-auto"
                                                src="{{ asset('uploads/products/thumbnails') }}/{{ $gImage }}"
                                                width="104" height="104" alt="" /></div>
                                    @endforeach
                                </div>
                            </div>
                ...
                <div class="col-lg-5">
                    ...
                    <div class="product-single__price">
                        <span class="current-price">
                            @if ($product->sale_price)
                                <s class="fw-medium me-2">${{ $product->regular_price }}</s>
                                {{ $product->sale_price }}
                            @else
                                ${{ $product->sale_price }}
                            @endif
                    ...
                    @if (Cart::instance('cart')->content()->where('id', $product->id)->count() > 0)
                        <a href="{{ route('cart.index') }}" class="btn btn-warning mb-3"> Go to Carts </a>
                    @else
                        ...
                        @foreach ($r_products as $r_product)
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details', ['product_slug' => $r_product->slug]) }}">
                                        <img loading="lazy"
                                            src="{{ asset('uploads/products') }}/{{ $r_product->image }}" width="330"
                                            height="400" alt="{{ $r_product->name }}" class="pc__img">
                                        @foreach (explode(',', $r_product->images) as $gImage)
                                            <img loading="lazy"
                                                src="{{ asset('uploads/products') }}/{{ $gImage }}" width="330"
                                                height="400" alt="{{ $r_product->name }}"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a
                                            href="{{ route('shop.product.details', ['product_slug' => $r_product->slug]) }}">{{ $r_product->name }}</a>
                                    </h6>
