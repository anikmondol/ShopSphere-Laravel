                            ...
                            <div class="swiper-slide product-card">
                                <div class="pc__img-wrapper">
                                    <a href="{{ route('shop.product.details',['product_slug'=>$r_product->slug]) }}">
                                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $r_product->image }}" width="330"
                                            height="400" alt="{{ $r_product->name }}" class="pc__img">
                                            @foreach (explode(',', $r_product->images) as $gImage)
                                        <img loading="lazy" src="{{ asset('uploads/products') }}/{{ $gImage }}" width="330"
                                ...
                                <div class="pc__info position-relative">
                                    ...
                                    <h6 class="pc__title"><a href="{{ route('shop.product.details',['product_slug'=>$r_product->slug]) }}">{{ $r_product->name }}</a></h6>
