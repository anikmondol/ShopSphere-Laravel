    ...
    <main class="pt-90">
        ...
        <section class="shop-checkout container">
            ...
            <div class="shopping-cart">
                    ...
                    <div class="cart-table__wrapper">
                        ...
                        <div>
                            @if (Session::has('success'))
                                <p class="text_success">{{ Session::get('success') }}</p>
                            @elseif (Session::has('error'))
                                <p class="text_danger">{{ Session::get('error') }}</p>
                            @endif
                        </div>
                            ...
                            <div class="mobile_fixed-btn_wrapper">
                                <div class="button-wrapper container">
                                    <a href="checkout.html" class="btn btn-primary btn-checkout "
                                        style="display: flex; align-items: center; justify-content: center;">PROCEED TO
                                        CHECKOUT</a>
                                </div>
                            </div>
                        </div>
                ...
                @else
                    <div class="row">
                        <div class="col-md-12 text-center pt-2 bp-5">
